$(function () { // Same as document.addEventListener("DOMContentLoaded"...
  $("#navbarToggle").blur(function(evento) {
  ...
  //Therefore, the blur event will not fire on user clicking somewhere else in the page and the blur event handler which is set up above will not be called. Refer to issue #28 in
  //the repo. Solution: force focus on the element that the click event fired on
...
var insertHtml=function(selector,html) {            //Convenience function for inserting innerHTML for 'select'
